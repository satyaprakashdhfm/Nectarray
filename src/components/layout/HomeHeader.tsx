...
/**
 * The home page's header: one flat night bar, 72px, fixed to the top.
 *
 * The other pages moved to the floating glass bar in Header.tsx; the home
 * page stayed on this one, which its hero is built around — Hero.tsx clears
 * exactly this 72px with its own top padding. Kept as its own component so
 * neither header has to carry a branch for the other.
 */
