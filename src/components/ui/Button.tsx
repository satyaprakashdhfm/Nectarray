...
const variants: Record<Variant, string> = {
  primary:
    "bg-ink text-cta-fg px-6 py-3.5 hover:bg-brand-deep shadow-[0_8px_24px_-12px_rgba(14,27,38,0.5)] hover:shadow-[0_12px_28px_-10px_rgba(20,127,174,0.55)]",
  secondary:
  ...
  onDark:
    "bg-white text-night px-6 py-3.5 hover:bg-leaf hover:text-night shadow-[0_8px_28px_-12px_rgba(0,0,0,0.6)]",
};
