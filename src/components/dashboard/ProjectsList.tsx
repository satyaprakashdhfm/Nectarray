...
/**
 * The five capstone builds, and how far this student has gotten with each.
 *
 * Its own component rather than inlined in a page, because it now renders in
 * two places: the Projects track inside Assignments, and — while a bookmark
 * or an old link still points at `/dashboard/projects` — that route too.
 * Neither owns the query.
 */
export async function ProjectsList({ userId }: { userId: string | null }) {
